...
class Customer(models.Model):
    ...
    customerImg=models.ImageField(upload_to='static/images/customer/', height_field=None, width_field=None, max_length=None,default='static/img/default/customer/default_user.png',blank=True)
    def __str__(self):
